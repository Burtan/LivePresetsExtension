    ...
    binaries.configureEach(CppTestExecutable::class.java) {
        ...
        if (targetMachine.architecture.name != MachineArchitecture.X86_64) {
            ...
            if (targetMachine.operatingSystemFamily.isWindows) {
                ...
                linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/x64/user32.lib")
                linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/x64/gdi32.lib")
                linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/x64/advapi32.lib")
                linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/x64/shell32.lib")
                linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/x64/comdlg32.lib")
            }
        }
    }
}
...
library {
    ...
    binaries.configureEach(CppSharedLibrary::class.java) {
        ...
        if (targetMachine.operatingSystemFamily.isWindows) {
            linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/${arch}/user32.lib")
            linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/${arch}/gdi32.lib")
            linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/${arch}/advapi32.lib")
            linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/${arch}/shell32.lib")
            linkTask.get().lib("C:/Program Files (x86)/Windows Kits/10/Lib/10.0.22621.0/um/${arch}/comdlg32.lib")
            ...
            val cResTask = tasks.register("cRes ${name.capitalize()}", WindowsResourceCompile::class.java) {
                ...
                includes("C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um")
                includes("C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/shared")
                includes("C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/ucrt")
